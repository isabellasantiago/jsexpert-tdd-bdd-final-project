...
const CustomerDataBuilder = require("../model/customerDataBuilder");

describe("Test Customer Data Builder", () => {
  ...
  describe("Customer Validation Rules", () => {
    ...
    it("should return an object error when creating a customer with invalid name", () => {
      const customer = CustomerDataBuilder.aCustomer().withInvalidName().build();
